...
- [2026-07-18-superpowers-lite-codex-cn-archives.md](./2026-07/2026-07-18-superpowers-lite-codex-cn-archives.md): 在 `plugins/superpowers-lite` 交付仅面向 Codex CLI/App 的中文插件，包含 14 个技能、无 Hook 运行面和可复现 rootless 归档。
