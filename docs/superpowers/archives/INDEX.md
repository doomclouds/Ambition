...
- [2026-07-18-superpowers-lite-plan-execution-handoff-archives.md](./2026-07/2026-07-18-superpowers-lite-plan-execution-handoff-archives.md): 建立书面计划到执行工作流的确定性交接，并为多交付当前会话执行补上按语义交付维护的 `update_plan` 状态。
- [2026-07-18-superpowers-lite-skill-depth-audit-archives.md](./2026-07/2026-07-18-superpowers-lite-skill-depth-audit-archives.md): 全量审计 13 个技能，以压力场景补强调试、TDD、验证与统一审查，并固化逐任务独立提交边界。
