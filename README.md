...
Claude Code、Cursor、Kimi、OpenCode、Pi 等平台适配层。
...
在 Codex CLI/App 的插件管理入口中，将本仓库目录或发布归档作为本地插件源添加。
插件名为 `superpowers-lite`，技能位于 `skills/`。安装后可直接描述任务；
`using-superpowers` 会先判断风险与规模，再选择真正匹配的技能。
...
- 贡献规则见 [CONTRIBUTING.md](https://github.com/doomclouds/Ambition/blob/main/CONTRIBUTING.md)。
- 安全边界和漏洞报告方式见 [SECURITY.md](https://github.com/doomclouds/Ambition/blob/main/SECURITY.md)。
